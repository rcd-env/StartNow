    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-gray-900/95 backdrop-blur-md rounded-3xl p-8 w-full max-w-md mx-4 border border-gray-700/50 shadow-2xl shadow-black/20">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          {type === "signup" && (
            <div>
              <label
                htmlFor="name"
                className="block text-sm font-semibold font-display text-gray-300 mb-3"
              >
                Full Name
              </label>
              <input
        ...
        >
          ...
          <span>
            {type === "login" ? "Log in using Google" : "Sign up using Google"}
          </span>
        </button>
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-400 font-medium font-display">
            ...
            <button
              onClick={() =>
                onSwitchType(type === "login" ? "signup" : "login")
              }
