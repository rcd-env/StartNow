...
const StartupDetail: React.FC = () => {
  ...
  const handleInvestment = async () => {
    ...
    try {
      // Simulate APTOS blockchain transaction
      console.log(`Investing ${investmentAmount} APTOS in ${project?.name}`);
...
Amount: ${investmentAmount} APTOS
Project: ${project?.name}
Your investment will be processed within 24 hours.`);
  ...
  if (!project) {
    return (
      <div className="fixed inset-0 bg-gray-900 flex items-center justify-center" style={{paddingTop: '120px'}}>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400">{project.industry} • {project.stage}</p>
                </div>
              </div>
            </div>
            ...
            <button
              ...
              className="bg-green-600 hover:bg-green-500 text-white font-semibold py-3 px-6 rounded-lg transition-colors flex items-center space-x-2"
            >
              <Wallet className="w-5 h-5" />
              <span>Invest with APTOS</span>
            </button>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              {/* Business Model */}
              <div className="bg-gray-800 rounded-2xl p-6">
                <h2 className="text-2xl font-bold text-white mb-4">Business Model</h2>
                <p className="text-gray-300 leading-relaxed">{project.businessModel}</p>
              </div>
              ...
              {/* Traction */}
              <div className="bg-gray-800 rounded-2xl p-6">
                <h2 className="text-2xl font-bold text-white mb-4">Traction & Achievements</h2>
                <p className="text-gray-300 leading-relaxed">{project.traction}</p>
              </div>

              {/* Competition */}
              <div className="bg-gray-800 rounded-2xl p-6">
                <h2 className="text-2xl font-bold text-white mb-4">Competitive Advantage</h2>
                <p className="text-gray-300 leading-relaxed">{project.competition}</p>
              </div>
                    ...
                    <ResponsiveContainer width="100%" height={350}>
                      <RechartsPieChart>
                        <Pie
                          ...
                          label={false}
                        >
                          {(chartData?.marketShareData || []).map((entry, index) => (
                  ...
                  <div>
                    ...
                    <ResponsiveContainer width="100%" height={300}>
                      <BarChart data={chartData?.financialData || []}>
                        ...
                        />
                        <Bar dataKey="revenue" fill="#ffee99" name="Revenue ($K)" />
                        <Bar dataKey="expenses" fill="#6B7280" name="Expenses ($K)" />
                        ...
                        <div key={index} className="flex items-center justify-between">
                          <div className="flex items-center space-x-2">
                            <div
                              ...
                              style={{ backgroundColor: entry.color }}
                            ></div>
                            <span className="text-gray-300 text-sm">{entry.category}</span>
                          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-800 rounded-2xl p-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-white font-semibold">{project.fundingRaised}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                    ...
                    <span className="text-white font-semibold">{project.fundingGoal}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                    ...
                    <span className="text-white font-semibold">{project.teamSize} people</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                    ...
                    <span className="text-white font-semibold">{project.foundedDate}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
              ...
              <div className="bg-gray-800 rounded-2xl p-6">
                ...
                <div className="space-y-4">
                  <div className="bg-gray-700 rounded-lg p-4">
                    ...
                    <p className="text-lg font-bold text-white">{project.financials.revenue}</p>
                  </div>
                  <div className="bg-gray-700 rounded-lg p-4">
                    <p className="text-gray-400 text-sm mb-1">Growth Rate</p>
                    <p className="text-lg font-bold text-green-400">{project.financials.growth}</p>
                  </div>
                  <div className="bg-gray-700 rounded-lg p-4">
                    <p className="text-gray-400 text-sm mb-1">Monthly Burn</p>
                    <p className="text-lg font-bold text-red-400">{project.financials.burn}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-800 rounded-2xl p-6">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-white font-semibold">{project.founder}</p>
                  </div>
                  <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3 p-3 bg-gray-700 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 text-xs">10+ years in {project.industry}</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3 p-3 bg-gray-700 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 text-xs">Former Google Engineer</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3 p-3 bg-gray-700 rounded-lg">
                    <div className="w-12 h-12 bg-gray-500 rounded-full flex items-center justify-center text-white font-bold text-lg">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 text-xs">Ex-Facebook Growth Team</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 text-xs">Successfully launched MVP with core features</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="w-3 h-3 bg-green-400 rounded-full mt-2"></div>
                    <div>
                      <p className="text-white font-semibold">First 1000 Users</p>
                      <p className="text-gray-400 text-sm">Q2 2023</p>
                      <p className="text-gray-300 text-xs">Reached 1000 active users milestone</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="w-3 h-3 bg-green-400 rounded-full mt-2"></div>
                    <div>
                      ...
                      <p className="text-gray-300 text-xs">Raised initial seed round from angel investors</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="w-3 h-3 bg-yellow-400 rounded-full mt-2"></div>
                    <div>
                      <p className="text-white font-semibold">Revenue Positive</p>
                      <p className="text-gray-400 text-sm">Q4 2023</p>
                      <p className="text-gray-300 text-xs">Achieved monthly recurring revenue of $50K</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="w-3 h-3 bg-blue-400 rounded-full mt-2"></div>
                    <div>
                      <p className="text-white font-semibold">Series A Target</p>
                      <p className="text-gray-400 text-sm">Q2 2024</p>
                      <p className="text-gray-300 text-xs">Planning Series A round for expansion</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Existing Investors */}
              <div className="bg-gray-800 rounded-2xl p-6">
                <h3 className="text-xl font-bold text-white mb-4">Existing Investors</h3>
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-gray-700 rounded-lg p-4 text-center">
                    ...
                    <p className="text-white font-semibold text-sm">Accel Partners</p>
                  ...
                  <div className="bg-gray-700 rounded-lg p-4 text-center">
                    ...
                    <p className="text-white font-semibold text-sm">Sequoia Capital</p>
                  ...
                  <div className="bg-gray-700 rounded-lg p-4 text-center">
                    ...
                    <p className="text-white font-semibold text-sm">Angel Investors</p>
                  ...
                  <div className="bg-gray-700 rounded-lg p-4 text-center">
                    ...
                    <p className="text-white font-semibold text-sm">Techstars</p>
                ...
                <div className="mt-6 pt-4 border-t border-gray-700">
                  <div className="grid grid-cols-3 gap-4 text-center">
                    ...
                    <div>
                      ...
                      <p className="text-yellow-400 font-bold text-lg">{project.fundingRaised}</p>
                    </div>
                    <div>
                      <p className="text-gray-400 text-xs">Last Round</p>
                      <p className="text-white font-bold text-lg">{project.stage}</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-gray-800 rounded-2xl max-w-md w-full p-6">
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="bg-blue-900 border border-blue-700 rounded-lg p-4">
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    <h4 className="text-blue-300 font-semibold text-sm">Investment Terms</h4>
            ...
            <div className="flex space-x-3">
              ...
              <button
                ...
                disabled={isInvesting || !investmentAmount || parseFloat(investmentAmount) < 10}
                className={`flex-1 font-semibold py-3 px-4 rounded-lg transition-colors flex items-center justify-center space-x-2 ${
                  isInvesting || !investmentAmount || parseFloat(investmentAmount) < 10
